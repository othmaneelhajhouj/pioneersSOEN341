/*
  ...
  - You are about to drop the column `aiBannerPath` on the `Event` table. All the data in the column will be lost.
  - You are about to drop the column `aiBannerUrl` on the `Event` table. All the data in the column will be lost.
