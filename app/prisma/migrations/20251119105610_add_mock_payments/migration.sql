/*
  ...
  - You are about to drop the column `generatedBannerPath` on the `Event` table. All the data in the column will be lost.
  - You are about to drop the column `generatedBannerUrl` on the `Event` table. All the data in the column will be lost.
